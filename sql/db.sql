...
CREATE TABLE `builds_opts` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=10942 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `options_deps`
--

DROP TABLE IF EXISTS `options_deps`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `options_deps` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `option` int(11) unsigned NOT NULL,
  `external` enum('yes','no') NOT NULL DEFAULT 'yes',
  `rpm_name` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
--
-- Table structure for table `packets_list`
--

DROP TABLE IF EXISTS `packets_list`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `packets_list` (
...
-- Dump completed on 2013-09-30 13:35:59
